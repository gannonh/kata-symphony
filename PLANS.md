...
8. KAT-229 Worker attempt pipeline (PR #13) review feedback addressed: maxTurns guard, replaceAll, resetForNextTurn stale fields, turn failure propagation, domain utility reuse cleanup
