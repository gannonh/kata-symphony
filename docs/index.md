...
* [A3 Implementation Stage](specs/2026-07-26-a3-implementation-stage-design.md) - Draft design for pinned approved specs → validated local/Docker implementation → linked draft PR
